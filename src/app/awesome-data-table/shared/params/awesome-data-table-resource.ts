import { AwesomeDataTableParams } from './awesome-data-table-params';

export class AwesomeDataTableResource<T> {

    constructor(private items: T[]) { }

    query(params: AwesomeDataTableParams, filter?: (item: T, index: number, items: T[]) => boolean): Promise<T[]> {
